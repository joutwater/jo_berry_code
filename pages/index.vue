    ...
    <div>
      ...
      <article class="section_break">
        <h3 class="flavor_title">Creation of the perfect blueberry</h3>
          <div class="flavor_text">Even if an agriculture company has far-reaching financial capabilities and cutting edge technology for product development, it doesn’t mean much if the consumer does not have any input in terms of the flavor quality. This drives intense and extensive research at the intersection of psychology and sensory analysis, in order to think of the best questions to ask, how to phrase them, what sort of scale to use, and so forth. As these proprietary tests evolve, their outcomes hone direct, nearly unbiased input from consumers that can be statistically analyzed to highlight patterns of significance. Such flavor patterns are then interpreted and connected to those of various volatile compounds, that would potentially create that exact flavor in a fruit. Let's see how this process works...
          </div>
      </article>
